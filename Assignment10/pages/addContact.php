...
$elementsArr = [
  "masterStatus"=>[
    ...
    "address"=>[
        ...
        "errorOutput"=>"",
        "type"=>"text",
        "value"=>"123 SomeStreet St",
        "regex"=>"address"
    ],
    "city"=>[
        "errorMessage"=>"<span style='color: red; margin-left: 15px;'>cannot be blank and must be a valid city name</span>",
        "errorOutput"=>"",
        "type"=>"text",
        "value"=>"Townville",
        "regex"=>"city"
    ...
    "dob"=>[
        "errorMessage"=>"<span style='color: red; margin-left: 15px;'>enter a real date in the format mm/dd/yyyy</span>",
        "errorOutput"=>"",
        "type"=>"text",
  ...
  "age"=>[
    "errorMessage"=>"<span style='color: red; margin-left: 15px;'>(you must select one)</span>",
    "errorOutput"=>"",
    "action"=>"required",
    "type"=>"radio",
